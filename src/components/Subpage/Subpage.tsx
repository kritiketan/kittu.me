    ...
    return (
        <Container title = {path.toUpperCase()}>
            ...
            <div className={HeaderSection}>
                ...
                <div id="Header Left 25%" className={HeaderSectionLeft25}>
                ...
                <div id="Header Right 75%" className={HeaderSectionRight75}>
            ...
            <section className={styles.horizontalSeperator}>
                <p>
                The motivation behind creating "What about PR". Although migration is not a new concept, rather one that predates modern civilization and humans, there have been a few notable events in the past which can be noted as waves of migration (think waves of coffee or revolutions).
                </p>
                <p>
